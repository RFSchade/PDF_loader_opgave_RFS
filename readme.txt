...
#======> Repository struktur
input: Mappe til input data. Her skal Excel filen med listen over PDF’er skal gemmes. 
Når programmet har kørt kommer denne mappe også til at indeholde en CSV version af 
Excel filen (pdf_list.csv). 
 
output: Mappe til output fra python scriptet. Kommer til at indeholde Excel-filen 
